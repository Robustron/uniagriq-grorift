      ...
      <div className="join-layout-grid">
        ...
        >
          {isCommunitySubscribed ? (
            ...
            <>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', width: '100%', flex: 1 }}>
                <input
                  type="email"
                  required
                  ...
                  style={{ width: '100%' }}
                />
                {subscribeError && <span style={{ color: '#ef4444', fontSize: '0.75rem', paddingLeft: '1rem' }}>{subscribeError}</span>}
              </div>
        ...
        <div className="join-socials">
          <a href="https://chat.whatsapp.com/GDP1jRAWsTi1JgUaqN8r3T" target="_blank" rel="noopener noreferrer" className="join-social-btn">
          ...
          <a href="https://www.instagram.com/uniagriq.ai" target="_blank" rel="noopener noreferrer" className="join-social-btn">
          ...
          <a href="https://www.linkedin.com/in/uniagriq-ai-9945b3406/" target="_blank" rel="noopener noreferrer" className="join-social-btn">
          ...
          <a href="https://x.com/uniagric" target="_blank" rel="noopener noreferrer" className="join-social-btn">
